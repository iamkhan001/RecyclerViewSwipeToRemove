...
<!-- blaze-out/k8-opt/genfiles/java/com/google/android/gmscore/integ/client/base/res/values-nl/strings.xml -->
<eat-comment/>
...
<string name="common_google_play_services_notification_channel_name" msgid="4293541511340436975">"Beschikbaarheid van Google Play-services"</string>
...
<string name="common_google_play_services_updating_text" msgid="7894275749778928941">"<xliff:g id="APP_NAME">%1$s</xliff:g> kan niet worden uitgevoerd zonder Google Play-services, die mom